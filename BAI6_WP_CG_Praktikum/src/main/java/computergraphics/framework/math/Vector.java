...
public class Vector implements Serializable {
	...
	/**
	 * Array contaising the values of the vector. Length of the array matches the vector dimension.
	 */
	...
	public Vector(int dimension, double... values) {
		if(Objects.requireNonNull(values.length) != dimension) {
			throw new IllegalArgumentException("Es wird ein " + dimension + "-dimensionaler Vektor gewünscht, aber "
					+ values.length + " Werte übergeben!");
		}
		this.values = values;
	}
...
//			System.out.println("Cannot normalize zero-vector!");
	...
	/**
	 * Specialized version of the toString() method with given precision for the coordinates.
