...
public class ColorizerDemo {
	public static void main(String[] args) {
		...
		system1.setParticleColorizer(new SpeedVisualizer(0));
		...
		system2.setParticleColorizer(new SpeedVisualizer(0, 1.5));
...
//		system3.addRepeller(new Repeller(new Vector(0, -1.5, 0), 0.5, 20));
		system3.setParticleColorizer(ParticleColorizerBuilder.uniformMultiColorGradient()
