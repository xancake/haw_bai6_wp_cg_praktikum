...
\begin{figure}[h]
	...
	\end{center}
\end{figure}
\textmd{\\Es sollte jedoch erwähnt werden, dass die Back-to-Front-Sortierung insbesondere bei einer großen Anzahl von Partikeln gewisse Performance-Einbußen mit sich führt. Während ein Partikelsystem mit 10000 Partikeln ohne Back-to-Front-Sortierung in meinen Tests mit einer Bildrate von 30 Frames-per-Second gerendert werden kann, so fällt die Bildrate mit Back-to-Front-Sortierung in dem Szenario auf 10 Frames-per-Second.}

\section{Anziehen und Abstoßen (?)} \label{attraction_repulsion}
\textmd{}
